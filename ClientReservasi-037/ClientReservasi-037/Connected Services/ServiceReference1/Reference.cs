...
namespace ClientReservasi_037.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        string UpdateRegister(string username, string password, string kategor, int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/UpdateRegister", ReplyAction="http://tempuri.org/IService1/UpdateRegisterResponse")]
        System.Threading.Tasks.Task<string> UpdateRegisterAsync(string username, string password, string kategor, int id);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/pemesanan", ReplyAction="http://tempuri.org/IService1/pemesananResponse")]
        System.Threading.Tasks.Task<string> pemesananAsync(string IdPemesanan, string NamaCustomer, string NoTelp, int JumlahPemesanan, string IdLokasi);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/editPemesanan", ReplyAction="http://tempuri.org/IService1/editPemesananResponse")]
        System.Threading.Tasks.Task<string> editPemesananAsync(string IdPemesanan, string NamaCustomer, string NoTelp);
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<ClientReservasi_037.ServiceReference1.IService1>, ClientReservasi_037.ServiceReference1.IService1 {
        ...
        public string UpdateRegister(string username, string password, string kategor, int id) {
            return base.Channel.UpdateRegister(username, password, kategor, id);
        }
        
        public System.Threading.Tasks.Task<string> UpdateRegisterAsync(string username, string password, string kategor, int id) {
            return base.Channel.UpdateRegisterAsync(username, password, kategor, id);
        }
        ...
        public string pemesanan(string IdPemesanan, string NamaCustomer, string NoTelp, int JumlahPemesanan, string IdLokasi) {
            return base.Channel.pemesanan(IdPemesanan, NamaCustomer, NoTelp, JumlahPemesanan, IdLokasi);
        }
        
        public System.Threading.Tasks.Task<string> pemesananAsync(string IdPemesanan, string NamaCustomer, string NoTelp, int JumlahPemesanan, string IdLokasi) {
            return base.Channel.pemesananAsync(IdPemesanan, NamaCustomer, NoTelp, JumlahPemesanan, IdLokasi);
        }
        
        public string editPemesanan(string IdPemesanan, string NamaCustomer, string NoTelp) {
            return base.Channel.editPemesanan(IdPemesanan, NamaCustomer, NoTelp);
        }
        
        public System.Threading.Tasks.Task<string> editPemesananAsync(string IdPemesanan, string NamaCustomer, string NoTelp) {
            return base.Channel.editPemesananAsync(IdPemesanan, NamaCustomer, NoTelp);
        }
